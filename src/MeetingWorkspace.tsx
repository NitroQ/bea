...
export default function MeetingWorkspace({ meeting, onBack, onNotice, onImport, onImportVtt, onRecording, onMeetingStatus, onRetryTranscription, onResumeTranscription, onRepairTools, repairing = [], busy, transcribeProgress, liveSegments = [] }: Props) {
...
function Overview({ transcript, minutes, meeting, resumeAvailable, onOpenTranscript, onGenerate, generating, onRetry, onResume, onRepairTools, toolsInstalling }: { transcript: TranscriptSegment[]; minutes: Minutes; meeting: Meeting; resumeAvailable: boolean; onOpenTranscript: () => void; onGenerate: () => void; generating: boolean; onRetry: () => void; onResume: () => void; onRepairTools: () => void; toolsInstalling: boolean }) {
  // "Needs attention" must explain itself: surface the persisted failure
  // reason plus the actions that fix it — resuming saved progress, retrying
  // from scratch, and (when the error smells like missing media tooling)
